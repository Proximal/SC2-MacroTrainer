...
; require libcurl.dll
; http://www.paehl.com/open_source/?CURL_7.32.0
/*
...
curl_formadd(Byref fPost, Byref lPost, Params){
    ...
    return DllCall("libcurl\curl_formadd"
                  ,"UInt*",fpost
                  ,"UInt*",lpost
                  ,"UInt" ,Fopt1 ,Fval2+0  ? "UInt" : val_type, (a_isunicode && Fval2+0="")  ? Fval2A  : Fval2
                  ,"UInt" ,Fopt3 ,Fval4+0  ? "UInt" : val_type, (a_isunicode && Fval4+0="")  ? Fval4A  : Fval4
                  ,"UInt" ,Fopt5 ,Fval6+0  ? "UInt" : val_type, (a_isunicode && Fval6+0="")  ? Fval6A  : Fval6
                  ,"UInt" ,Fopt7 ,Fval8+0  ? "UInt" : val_type, (a_isunicode && Fval8+0="")  ? Fval8A  : Fval8
                  ,"UInt" ,Fopt9 ,Fval10+0 ? "UInt" : val_type, (a_isunicode && Fval10+0="") ? Fval10A : Fval10, "CDecl")
...
*/
cURL_Easy_Escape(cHandle, Param, uLen=0){
    a_isunicode ? (VarSetCapacity(ParamA, StrPut(Param, "CP0")), StrPut(Param, &ParamA, "CP0"))

    return DllCall("libcurl\curl_easy_escape"
                  ,"UInt", cHandle
                  ,"Str" , a_isunicode ? ParamA : Param
                  ,"UInt", uLen ? uLen : StrLen(Param))
}
