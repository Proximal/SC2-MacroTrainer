...
;	Gui, Options:+Disabled
  ...
  ;  if p_OptionalAttrib
   ...
   ;     }
	...
	; Gui, %s_GUI%:Add, Link, x+150, <a href="http://www.autohotkey.com/docs/Hotkeys.htm">Hotkey Help</a> ;link doesnt work anymore ???
	Gui, %s_GUI%:Font, underline   
	Gui, %s_GUI%:Add, Text, x+150 cBlue gLinkLabel, Hotkey Help ;linklabel is in the other hotkeygui (as 'link' stoppped working)
	Gui, %s_GUI%:Font, norm
