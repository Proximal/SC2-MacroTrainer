...
VarSizeType BIV_mtTimeIdle(LPTSTR aBuf, LPTSTR aVarName)
{
	...
	if (!aBuf)
		return MAX_INTEGER_LENGTH;
	return (VarSizeType)_tcslen(ITOA64(GetTickCount() - g_mtTimeIdle, aBuf));
}
...
#endif
#ifdef _WIN64
	return_value = DynaCall(function, this->mdyna_param, arg_count, exception_occurred);
#endif
