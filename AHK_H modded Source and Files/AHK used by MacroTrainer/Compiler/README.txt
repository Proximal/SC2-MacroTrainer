...
The compiler 'Ahk2Exe' comes in script and exe form. 

You can compile macro trainer by running the Ahk2Exe.exe file and specifying 
MacroTrainerAutoHotkeySC.bin as the Base File (.bin). This is the simplest method.
