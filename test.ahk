...
msgbox % A_mtIsInputBlocked " | " A_PtrSize
return 

$f1::
soundplay *-1
MTBlockInput, On
;msgbox % A_mtIsInputBlocked 
s := A_TickCount
...
f1::
BlockInput, ExcludeMouseMoveOn
sleep 5000
BlockInput, ExcludeMouseMoveOff 
return 


/*

    || InStr(keyName, "shift") || InStr(keyName, "Alt") || InStr(keyName, "Win")
    || InStr(keyName, "Control") || InStr(keyName, "AppsKey")
    || InStr(keyName, "Wheel"))

sClass:="WindowsForms10.EDIT.app.0.21093c0_r13_ad" 

Array := {Contact: 113, Company: 112, Title:128, Department: 134, Salutation: 114, Phone: 1116, PhoneExt: 115, Mobile: 127, Email: 123, Website: 21, Address: 111, City: 130, Sate: 129, Zip: 110, MailTo: 18, Mail_City: 19, Country: 125, Fax: 173, PersonEmail: 123, FTP_User: 15, FTP_Pass: 16, IDStatus: 131, Activity: 17, Reffered: 126, LastEmail: 116, LastCallStart: 117, LastCallEnd: 120, Meeting: 122, LetterSent: 119, LastResult: 124}
...
For i, value in Array 
    s .= 
  msgbox %   aControl := sClass . Array[i] 
   msgbox % aControl:=aControl
    gosub, append

msgbox % s
return 
append:
thiscontrol:= aName . aControl

if (thiscontrol !="")
    s .= thiscontrol "`n"
    ;FileAppend, %thiscontrol%`n, blah.txt
return
...
Struct: URL_COMPONENTS  (size:  104)
Member:                       Offset:  Type:
dwStructSize                  @ 0      unsigned long
lpszScheme                    @ 8      wchar_t * __ptr64
dwSchemeLength                @ 16     unsigned long
nScheme                       @ 20     int
lpszHostName                  @ 24     wchar_t * __ptr64
dwHostNameLength              @ 32     unsigned long
nPort                         @ 36     unsigned short
lpszUserName                  @ 40     wchar_t * __ptr64
dwUserNameLength              @ 48     unsigned long
lpszPassword                  @ 56     wchar_t * __ptr64
dwPasswordLength              @ 64     unsigned long
lpszUrlPath                   @ 72     wchar_t * __ptr64
dwUrlPathLength               @ 80     unsigned long
lpszExtraInfo                 @ 88     wchar_t * __ptr64
dwExtraInfoLength             @ 96     unsigned long
...
0         DWORD('StructSize');
4         UINT ('SchemeName');
8         DWORD('SchemeNameLength');
12        INT  ('Scheme');
16        UINT ('HostName');
20        DWORD('HostNameLength');
24        INT  ('Port');
28        UINT ('UserName');
32        DWORD('UserNameLength');
36        UINT ('Password');
40        DWORD('PasswordLength');
44        UINT ('UrlPath');
48        DWORD('UrlPathLength');
52        UINT ('ExtraInfo');
56        DWORD('ExtraInfoLength')
